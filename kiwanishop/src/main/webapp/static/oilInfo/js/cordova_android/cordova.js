...
function findCordovaPath() {
    ...
    var term = web_path + '/static/js/cordova_android/cordova.js';
...
exports.load = function(callback) {
    ...
    injectIfNecessary('cordova/plugin_list', pathPrefix + web_path + '/static/js/cordova_android/cordova_plugins.js', function() {
