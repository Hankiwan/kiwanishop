$(function() {
    ...
    $(document).ready(function() {
    	banner_width = $(".clsBannerScreen").width();
        banner_height = $("#banner img").height();
        
        $(".clsBannerScreen").css("width",banner_width+"px").css("height",banner_height+"px");
    });
	
	$(function() {
		$("#banner").jQBanner({nWidth:banner_width,
		nHeight:banner_height,nCount:2,
		isActType:"left",nOrderNo:1,
		isStartAct:"N",
		isStartDelay:"Y",
		nDelay:5000,
		isBtnType:"li"});
