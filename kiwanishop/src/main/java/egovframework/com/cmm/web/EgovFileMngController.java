...
public class EgovFileMngController {
	...
	if((String)commandMap.get("fileDown") != null){
		String fileDown = (String)commandMap.get("fileDown");
	...
	if("fileRemoveAjax".equals(returnUrl)){
		return "portal/adm/com/menu/ComMenuManageFileRemoveAjax";
	}
