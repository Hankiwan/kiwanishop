...
public class FileVO implements Serializable {
	...
	/**
	 * popznSn attribute 를 리턴한다.
	 * @return String
	 */
	public String getPopznSn() {
		return popznSn;
	}

	/**
	 * popznSn attribute 값을 설정한다.
	 * @param popznSn String
	 */
	public void setPopznSn(String popznSn) {
		this.popznSn = popznSn;
	}
