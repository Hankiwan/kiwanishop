...
public class FileManageDAO extends EgovAbstractDAO {
     ...
     */
    @SuppressWarnings("unchecked")
    public String insertFileDetailInfs(List fileList) throws Exception {
	FileVO vo = (FileVO)fileList.get(0);
	String atchFileId = vo.getAtchFileId();
     ...
     * @throws Exception
     */
    public void insertFileMasterInf(FileVO vo) throws Exception {
    	//insert("FileManageDAO.insertFileMaster", vo);
    }
    ...
    public void deleteAllFileInf(FileVO fvo) throws Exception {
    	//delete("FileManageDAO.deleteCOMTNFILE", fvo);
    }
    ...
    public void deleteDetailFileInf(FileVO fvo) throws Exception {
    	delete("FileManageDAO.deleteDetailCOMTNFILE", fvo);
    }
